...
print(grafIzobrazbaZivljenjskistroski)
```
...
# Zaključek
Pri izdelavi projekta sem užival in se naučil veliko novih uporabnih metod za obdelavo podatkov. Prav tako pa sem poleg tega pridobil tudi znanja o temi, ki sem si jo pri projektu izbral.
