...
uvoz.place <- function(tabelaPlace){
  ...
  names(tabelaPlace) <- c("Drzava", "Visina.plačce")
...
```{r}
library(ggplot2)
ggplot(data = zdruzenaPlaceBDP, aes(x=Drzava, y=Vrednost.BDP)) +
  geom_bar(stat = "Identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1),text = element_text(size=)) +
  coord_flip()
```
